...
function removeDuplicatesInPlace(arr) {
  ...
  for (let i = 0; i < arr.length; i++)
    ...
    if (newSet.has(arr[i])) {
      ...
      //   delete arr[i] // мій варіант (працює без зменшення i--)
      arr.splice(i, 1) // варіант вихователя - на мою думку більш правильний
